...
public final class GeOffersPanelPreview
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		g.translate(8, 8);
		final Dimension d = GeOffersPanelOverlay.paint(g, rows);
		g.dispose();
		final File out = new File(args.length > 0 ? args[0] : "offers-panel.png");
		ImageIO.write(img, "png", out);
		System.out.println("wrote " + out.getAbsolutePath() + " panel " + d.width + "x" + d.height);
	}
}
